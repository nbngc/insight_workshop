# # 9. Write a binary search function. It should take a sorted sequence and the item it is looking for. It should
# return the index of the item if found. It should return -1 if the item is not found.
